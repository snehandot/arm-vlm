...
// Add this function to export the canvas and send to server
function sendScreenshotToServer() {
    ...
    // Use JPEG for smaller, faster uploads
...
// Throttle to every 2 seconds for reliability
setInterval(sendScreenshotToServer, 2000);
// Add a button to trigger the screenshot upload
window.addEventListener('DOMContentLoaded', () => {
    const btn = document.createElement('button');
    btn.textContent = 'Send Screenshot to Server';
    btn.style.position = 'fixed';
    btn.style.top = '10px';
    btn.style.right = '10px';
    btn.style.zIndex = 10000;
    btn.onclick = sendScreenshotToServer;
